...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        /**客户类型变更**/
        async function fetchChangeClient(clientId: number, item: Omix) {
                            ...
                            <common-element-columns-template class="gap-x-24" type="auto-fit" number={450}>
                                ...
                                >
                                    <form-common-column-select
                                        ...
                                        options={props.clientOptions.dataSource.value}
                                        on-change:value={fetchChangeClient}
                                    ></form-common-column-select>
                                </form-common-column>
                                <form-common-column
                                    label="选择应用"
                            ...
                            <div class="flex-1 relative overflow-hidden">
                                ...
                                >
                                    <n-transfer
                                        ...
                                        source-filterable
                                        target-filterable
                                        v-model:value={formState.value.items}
